...
public class ApplicationTest {
	...
	private static final Double SIMULATION_RESULT = 90.12;
	...
	@DisplayName("prints usage if less than 3 arguments")
	@Test
	...
	@DisplayName("prints usage if more than 3 arguments")
	@Test
	...
	@DisplayName("calls simulate with the 3 arguments")
	@Test
	void callsSimulateWithThe3Arguments() {
		...
		verify(simulation).simulate(PARTICLES, TIME, MAX_VELOCITY);
	}
	...
	void printsSimulationResult() {
		...
		when(simulation.simulate(anyLong(), anyDouble(), anyLong()))
